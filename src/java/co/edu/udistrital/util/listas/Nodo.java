 ...
 * (incluyendo {@link ListaEnlazadaSimple} y
 * {@link ListaEnlazadaSimpleCircular}). Almacena un dato de tipo {@code T} y
...
public class Nodo<T> {
    ...
    private T dato;
    /**
     * Referencia al siguiente nodo en la lista, o {@code null} si este es el
     * último.
     */
    private Nodo<T> siguiente;

    /**
     * Construye un nodo con el dato especificado y sin nodo siguiente
     * ({@code null}).
     *
    ...
    /**
     * Construye un nodo con el dato y la referencia al siguiente nodo
     * especificados.
     *
    ...
    // --- Setters ---
    /**
     * Establece o actualiza el dato almacenado en este nodo. Útil para
     * operaciones como la ordenación por intercambio de datos.
     *
    ...
    /**
     * Establece o actualiza la referencia al siguiente nodo. Permite modificar
    ...
    /**
     * Devuelve una representación textual del dato contenido en el nodo. Si el
     * dato es {@code null}, devuelve la cadena "null".
     *
