 ...
 * de Inserción (Insertion Sort). Este algoritmo construye la lista ordenada
 * final un elemento a la vez, tomando elementos de la lista de entrada y
 * colocándolos en su posición correcta dentro de una sublista ya ordenada. Es
 * eficiente para listas pequeñas o casi ordenadas.
 *
 * <p>
 * Esta implementación modifica los enlaces {@code siguiente} de los
 * {@link Nodo}s para reordenar la lista.</p>
 *
 * <p>
 * Complejidad Temporal: O(n^2) en peor y caso promedio, O(n) en mejor caso (ya
 * ordenada).</p>
 * <p>
 * Complejidad Espacial: O(1) (ordenación in situ).</p>
 *
...
public class OrdenamientoInsercion<T extends Comparable<T>> implements EstrategiaOrdenamiento<T> {
    ...
    /**
     * Método auxiliar privado para insertar un {@code nodoAInsertar} en la
     * lista ordenada referenciada por {@code cabezaOrdenada}, manteniendo el
     * orden.
     *
