 ...
 * Burbuja (Bubble Sort). Este algoritmo itera repetidamente sobre la lista,
 * comparando elementos adyacentes e intercambiándolos si están en el orden
 * incorrecto. Es simple pero ineficiente para grandes listas.
 *
 * <p>
...
public class OrdenamientoBurbuja<T extends Comparable<T>> implements EstrategiaOrdenamiento<T> {
    ...
    /**
     * Ordena la lista dada usando el algoritmo de Burbuja mediante intercambio
     * de datos.
     *
