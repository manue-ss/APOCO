...
import co.edu.udistrital.util.generador.GeneradorCorruptos;
 ...
 * @author Acer-Pc
 */
@WebServlet(name = "CorruptosServlet", urlPatterns = {"/CorruptosServlet"})
public class CorruptosServlet extends HttpServlet {

    private final TestAlgoritmosService<Corrupto> testService = new TestAlgoritmosService<>();
    private final GeneradorCorruptos generador = new GeneradorCorruptos();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            System.out.println(cantidadParam + "  " + cantidad);

            ListaEnlazadaSimple<Corrupto> lista = generador.generarLista(cantidad);
            ...
            List<Corrupto> listaOriginal = lista.toStandardList();
            ListaEnlazadaSimple<Corrupto> listaEnlazadaOrdenada = lista.clonarLista();
            listaEnlazadaOrdenada.ordenar(new OrdenamientoQuickSort<>());
            List<Corrupto> listaOrdenada = listaEnlazadaOrdenada.toStandardList();
            ...
            request.getRequestDispatcher("politicos.jsp").forward(request, response);
